function [Wh,f, Info] = nemilsmi_cont(X, Y, options)
%
% Continuous case.
% 
...
sigmaz_list = myProcessOptions(options, 'sigmaz_list', (1/sqrt(2))*[0.5 1 2] );
...
%
cvevery = myProcessOptions(options, 'cvevery', 1); % CV every iteration 
...
refInfo = Ref();
funObj =  @(Wx, ref)(fobjNemiLSMI_cont(Wx, X, Y, const, options, ref));
[ Wh, Info ] = nemisolver(W0, funObj, options, refInfo);
