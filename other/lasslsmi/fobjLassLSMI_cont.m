function [ nlsmip, DF] = fobjLassLSMI_cont(W, X, Y, const, options)
% 
...
% fprintf('CV: sigmaz=%.2g, lamb=%.2g\n', best_sigmaz, best_lsmilambda);
...
nlsmi = -lsmi;
nlsmip = nlsmi + 0.5*options.rho*(W'*W);
...
if nargout > 1
    ...
    DF = -deriveIByW(W, X, Xc, Alpha, BKy, BKz, best_sigmaz) + options.rho*W;
