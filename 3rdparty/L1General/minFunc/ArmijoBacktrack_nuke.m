function [t,x_new,f_new,g_new,funEvals,H] = ArmijoBacktrack_nuke(...
    x,t,d,f,fr,g,gtd,c1,LS,tolX,debug,doPlot,saveHessianComp,funObj,...
    varargin)
%
...
if nargout == 6 && funEvals > 1 && saveHessianComp
    % LASTLINE_SEARCH signal
    infoRef.obj.signal = OS.LAST_LINE_SEARCH;
