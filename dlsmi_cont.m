function [Wh,f,infoLog] = dlsmi_cont(X, Y, options)
%
% Continuous case.
% 
...
options = rmfield(options, 'sigmayfactor_list');
...
funObj = @(Wx, refInfo)(funObjNegLSMI_cont(Wx, X, Y, const, options, refInfo));
